...
lyr_Ciudad_de_Ayacucho0.set('fieldImages', {'IDMANZANA': 'TextEdit', 'NOMCCPP': 'TextEdit', 'Shape_Leng': 'TextEdit', });
lyr_Ciudad_de_Ayacucho0.set('fieldLabels', {'IDMANZANA': 'no label', 'NOMCCPP': 'no label', 'Shape_Leng': 'no label', });
